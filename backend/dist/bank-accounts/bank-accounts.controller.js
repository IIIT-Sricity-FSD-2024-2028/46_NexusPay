...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Link a new bank account' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Deduct amount from primary bank account' }),
    (0, swagger_1.ApiBody)({ schema: { properties: { userId: { type: 'string' }, amount: { type: 'number' } } } }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Object)
], BankAccountsController.prototype, "deduct", null);
__decorate([
    (0, common_1.Post)('credit'),
    (0, swagger_1.ApiOperation)({ summary: 'Credit amount to primary bank account' }),
    (0, swagger_1.ApiBody)({ schema: { properties: { userId: { type: 'string' }, amount: { type: 'number' } } } }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Object)
], BankAccountsController.prototype, "credit", null);
__decorate([
    (0, common_1.Put)(':id'),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Remove bank account' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Object)

...
let LogsController = class LogsController {
    ...
    findAll(module, severity) {
        const filters = { module, severity };
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ schema: { properties: { user: { type: 'string' }, action: { type: 'string' }, module: { type: 'string' }, severity: { type: 'string' }, details: { type: 'string' } } } }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete log entry' }),

...
export class TransactionsRepository {
  private store = new JsonStore<TransactionRecord>('transactions.json', SEED);

  findAll(): TransactionRecord[] { return this.store.readAll(); }
  findById(id: string): TransactionRecord | undefined { return this.store.readAll().find(t => t.id === id); }
  nextId(): string { return this.store.getNextId('TXN'); }
